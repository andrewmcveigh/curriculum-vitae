...
\subsection*{Platforms, Tools \& Frameworks}
...
\section*{Experience}
\subsection*{Director / Consultant / Software Engineer: Modfacto LTD [2025 - Present]}
...
\subsection*{Principal Engineer: Swirrl IT LTD ... TPXimpact [2019 - 2024]}
...
Worked across a broad range of technologies spanning web and geospatial
      ...
      applications.
\subsubsection*{\emph{Core Infrastructure \& Platform}}
...
\subsubsection*{\emph{Environment Agency Programme – Lead Engineer}}
...
\paragraph*{\emph{Key contributions included:}}
\begin{itemize}
\item Architectural oversight and engineering direction for several production systems.
\item Leading reliability and operational improvements for public-facing data services.
\item Rewriting the Catchment Data Explorer to modernise its architecture and improve maintainability and performance.
\item Taking the Shoreline Management Plan platform from prototype through
           to full production.
\item Worked closely with client stakeholders to translate complex
           environmental and policy requirements into robust, production-grade
           systems.
\end{itemize}
\subsection*{Senior Software Engineer: Habito [2018]}
