...
you can do with it if you're willing to bend the rules a bit."]]]
   ...
   [:h1 "Experience"
    [:h2 "Director / Consultant / Software Engineer: Modfacto LTD [2025 - Present]"
     [:p
     ...
     [:p
      ...
      in Rust, responsible for system design and implementation with a focus on
    ...
    [:h2 "Principal Engineer: Swirrl IT LTD ... TPXimpact [2019 - 2024]"
     ...
     [:p
      ...
      processing/ETL. Used SPARQL/graph databases linked data, with some use of
      PostgreSQL/PostGIS for data storage and geospatial processing. Leveraged
      cloud platforms such as AWS and Google Cloud for deployment, scalability,
      and cost managment. Worked extensively with geospatial linked-data formats
      and tooling, including processing shapefiles and generating Mapbox Vector
      Tiles, supporting the development of data-intensive, map-driven
      applications."
      ]
     ...
     Agency, providing technical ownership across multiple concurrent projects
     spanning product development and site reliability."]
     ...
     [:ul
      ...
      [:li "Taking the Shoreline Management Plan platform from prototype through
           to full production."]
      [:li "Worked closely with client stakeholders to translate complex
...
platform."]
     ...
     [:p "My responsibilities were to lead infrastructure projects as part of the backend
...
restrictions on the handsets."]
     ...
     [:p "Recent infrastructure highlights include a move of the whole product and
...
read heads, and scale the database horizontally relatively quickly, whilst cost
